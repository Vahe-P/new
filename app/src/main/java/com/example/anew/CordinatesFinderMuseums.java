...
public class CordinatesFinderMuseums {
    ...
    public void getMuseumCoordinates(double userLat, double userLng, int radius, String apiKey, TextView resultView, GridLayout resultsContainer) {

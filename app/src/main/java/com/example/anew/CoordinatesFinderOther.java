                ...
                if (photoUrl != null) {
                    ...
                    ImageRequest imageRequest = new ImageRequest(photoUrl,
                            ...
                            error -> {
                                ...
                                imageView.setImageResource(R.drawable.baseline_error_24); // Example error image
                            });
                    queue.add(imageRequest);
                } else {
                    imageProgressBar.setVisibility(View.GONE); // Hide ProgressBar if no photoUrl
                    imageView.setImageResource(R.drawable.baseline_hide_image_24); // Example 'no image' placeholder
                }

...
public class CordinatesFinderParks {
    ...
    public void getParkCoordinates(double userLat, double userLng, int radius, String apiKey, TextView resultView, GridLayout resultsContainer) {
